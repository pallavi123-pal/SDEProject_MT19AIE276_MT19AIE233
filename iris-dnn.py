...
get_ipython().run_cell_magic('sqlflow', '', 'describe iris.train;')
...
get_ipython().run_cell_magic('sqlflow', '', 'select * from iris.train limit 5;')
...
get_ipython().run_cell_magic('sqlflow', '', 'SELECT * FROM iris.train TO TRAIN DNNClassifier WITH\n  model.n_classes = 3,\n  model.hidden_units = [10, 10],\n  train.epoch = 10\nCOLUMN sepal_length, sepal_width, petal_length, petal_width\nLABEL class\nINTO sqlflow_models.my_dnn_model;')
...
get_ipython().run_cell_magic('sqlflow', '', 'SELECT * FROM iris.train TO TRAIN sqlflow_models.AutoClassifier WITH\n  model.n_classes = 3,\n  train.epoch = 10\nCOLUMN sepal_length, sepal_width, petal_length, petal_width\nLABEL class\nINTO sqlflow_models.my_dnn_model;')
...
get_ipython().run_cell_magic('sqlflow', '', 'SELECT * FROM iris.test TO PREDICT iris.predict.class USING sqlflow_models.my_dnn_model;')
...
get_ipython().run_cell_magic('sqlflow', '', 'SELECT * FROM iris.predict LIMIT 5;')
